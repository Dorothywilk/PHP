...
<div class="container">
 ...
 <!-- Logo -->
            <span class="nav-item active logo-sn waves-light">
                            <a class="pl-0" href="http://do"><img id="GC7-logo" src="assets/images/logo_150x93_c7.png"
                                                                  width="70px" alt="GC7 Logo"></a> <a
                class="navbar-brand font-weight-bold" href="/">Do</a>
            </span>
        ...
        <a class="nav-link font-weight-bold navbar-text" href="/agc7">GC7</a>
      </span>

    </span>

           <span class="nav-item col-md-3">
...
<header class="ui header" style="margin: 75px auto 0;">
  <p href="/" class="font-weight-bold">Exemples de MDBootstrap</p>
</header>
