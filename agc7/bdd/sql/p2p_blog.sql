...
CHANGE COLUMN `utilisateur_id` `utilisateur_id` INT(10) UNSIGNED NULL DEFAULT NULL
AFTER `id`;
...
ADD CONSTRAINT `FK_categorie_article_categories` FOREIGN KEY (`categorie_id`) REFERENCES `categories` (`id`)
  ON UPDATE CASCADE
  ON DELETE CASCADE,
ADD CONSTRAINT `FK_categorie_article_articles` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`)
  ON UPDATE CASCADE
  ON DELETE CASCADE;
...
INSERT INTO `p2p_blog`.`utilisateurs` (`pseudo`, `email`, `passe`)
VALUES ('GC7', 'fdsfds@dfsfds.com', 'dfdsfds');
INSERT INTO `p2p_blog`.`utilisateurs` (`pseudo`, `email`, `passe`)
VALUES ('Li', 'Li@dfsfds.com', 'lili');


ALTER TABLE `articles`
ADD CONSTRAINT `FK_articles_utilisateurs` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateurs` (`id`)
  ON UPDATE CASCADE
  ON DELETE SET NULL;

ALTER TABLE `commentaires`
ADD CONSTRAINT `FK_commentaires_utilisateurs` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateurs` (`id`)
  ON UPDATE CASCADE
  ON DELETE SET NULL;

ALTER TABLE `commentaires`
ADD CONSTRAINT `FK_commentaires_articles` FOREIGN KEY (`id_article`) REFERENCES `articles` (`id`)
  ON UPDATE CASCADE
  ON DELETE CASCADE;
