...
?>
  <div class="jumbotron">
    ...
    <h3 class="meaDo mt10 pb10">Date / Heure</h3>

    <p class="lead mt10">Fonctions temporelles</p>

    <p><code>DATE</code>, <code>TIME</code>, <code>DATETIME</code>, <code>TIMESTAMP</code>, <code>YEAR</code>,
      etc...</p>
...
$sql = 'SELECT nom, date_naissance,
       DATE_FORMAT(date_naissance, "le %W %e %M %Y") AS jolie_date
FROM Animal
WHERE espece_id = 4 limit 3';
$req( $sql );
