...
?>
<div class="jumbotron">
  <h3 class="meaDo mt10">UNION [ALL]</h3>
...
$sql = '(SELECT id, nom, ("<em>Non renseigné</em>") AS propriétaire, espece, sexe, "pets" AS "<= Table"
FROM pets limit 3)
UNION
...
order by id, Source
limit 3';
aff( 'SELECT id, nom, espece, sexe, date_naissance, "sql 1" AS "Source"<br>FROM <g>pets</g>
<g>UNION ALL</g>
...
<div class="jumbotron jumbotronRef">
  ...
  $sql = 'SELECT id, clt_id, nom, espece, sexe, commentaires FROM animaux WHERE clt_id > "" LIMIT 3';
  $req( $sql );
