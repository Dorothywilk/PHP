<?php /** * * This file is part of the official French Language Package * for the phpBB Forum Software. * * @copyright
(c) phpBB Limited <https://www.phpbb.com> * @copyright (c) Maël Soucaze <https://www.maelsoucaze.com> * @license GNU
General Public License, version 2 (GPL-2.0) * * For information about the language package, please see *
...
$lang = array_merge($lang, array(
	...
	<br><br> <font color="red">En cliquant sur le bouton " J\'accepte " ci-dessous:<br> Vous reconnaissez avoir lu dans son intégralité le présent réglement.<br>Vous vous engagez à restpecter sans réserve le présent réglement.<br>   </font> 
	',
