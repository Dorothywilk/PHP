...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'rmcgirr83.elonw.ucp_listener' => 'getRmcgirr83_Elonw_UcpListenerService',
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'wwwsublaadminli', 'Kaelc777', 'wwwsubl_forum', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('rmcgirr83.elonw.ucp_listener', 'rmcgirr83\\elonw\\event\\ucp_listener');
    ...
    {
        return $this->services['rmcgirr83.elonw.listener'] = new \rmcgirr83\elonw\event\listener($this->get('template'), $this->get('user'));
    }

    /**
     * Gets the 'rmcgirr83.elonw.ucp_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \rmcgirr83\elonw\event\ucp_listener A rmcgirr83\elonw\event\ucp_listener instance.
     */
    protected function getRmcgirr83_Elonw_UcpListenerService()
    {
        return $this->services['rmcgirr83.elonw.ucp_listener'] = new \rmcgirr83\elonw\event\ucp_listener($this->get('config'), $this->get('request'), $this->get('template'), $this->get('user'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'wwwsublaadminli',
            'dbal.dbpasswd' => 'Kaelc777',
            'dbal.dbname' => 'wwwsubl_forum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
