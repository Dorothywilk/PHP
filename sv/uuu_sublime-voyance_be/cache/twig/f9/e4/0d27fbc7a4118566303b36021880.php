...
/* acp_database.html */
class __TwigTemplate_f9e40d27fbc7a4118566303b36021880 extends Twig_Template
{
...
\t";
            // line 10
            if (twig_length_filter($this->env, $this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "files"))) {
                // line 11
...
\t\t<dd><select id=\"file\" name=\"file\" size=\"10\">";
                ...
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "files"));
                foreach ($context['_seq'] as $context["_key"] => $context["files"]) {
                    echo "<option value=\"";
                    echo $this->getAttribute((isset($context["files"]) ? $context["files"] : null), "FILE");
                    echo "\"";
                    if ($this->getAttribute((isset($context["files"]) ? $context["files"] : null), "S_LAST_ROW")) {
                        echo " selected=\"selected\"";
                    }
                    echo ">";
                    echo $this->getAttribute((isset($context["files"]) ? $context["files"] : null), "NAME");
                    echo "</option>";
                }
...
\t\t<dd>";
            // line 67
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "methods"));
            foreach ($context['_seq'] as $context["_key"] => $context["methods"]) {
                // line 68
                echo "\t\t<label><input name=\"method\"";
                if ($this->getAttribute((isset($context["methods"]) ? $context["methods"] : null), "S_FIRST_ROW")) {
                    echo " id=\"method\" checked=\"checked\"";
                }
                echo " type=\"radio\" class=\"radio\" value=\"";
                echo $this->getAttribute((isset($context["methods"]) ? $context["methods"] : null), "TYPE");
                echo "\" /> ";
                echo $this->getAttribute((isset($context["methods"]) ? $context["methods"] : null), "TYPE");
                echo "</label>
\t\t";
...
\t\t";
            // line 81
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "tables"));
            foreach ($context['_seq'] as $context["_key"] => $context["tables"]) {
                // line 82
                echo "\t\t\t<option value=\"";
                echo $this->getAttribute((isset($context["tables"]) ? $context["tables"] : null), "TABLE");
                echo "\">";
                echo $this->getAttribute((isset($context["tables"]) ? $context["tables"] : null), "TABLE");
                echo "</option>
\t\t";
