<?php   
/**
 * @package Amiant CSS3 Menu
 * 
 * @author Count Raven Amiant <cravener@gmail.com>
 * @copyright  Copyright (c) 2012 Count Raven From Country Amiant. (http://countraven.blogspot.com/)
 * @license    http://www.concrete5.org/license/     MIT License
 *
 * Based on original Autonav block from Concrete5 CMS
 * 
 */

/**
 * An object used by the Amiant CSS3 Menu to display navigation items in a tree
 *
 * @author Count Raven Amiant <cravener@gmail.com>
 * @copyright  Copyright (c) 2012 Count Raven From Country Amiant. (http://countraven.blogspot.com/)
 * @license    http://www.concrete5.org/license/     MIT License
 ...
 */
	...
	class AmiantCss3MenuBlockItem {
		 ...
		 * @param int $level
		 */
		function AmiantCss3MenuBlockItem($itemInfo, $level = 1) {
	...
	class AmiantCss3MenuBlockController extends BlockController {

		protected $btTable = 'btAmiantCss3Menu';
			...
			if ($cParentID != null) {
				...
				*/
				...
				if ($cParentID == 1) {
					...
					$ni = new AmiantCss3MenuBlockItem($niRow, 0);
					...
					if ($this->displaySubPages != 'relevant_breadcrumb' || (in_array($row['cID'], $this->cParentIDArray) || $row['cID'] == $this->cID)) {
						...
						*/
						...
						if ($displayPage) {
							...
							$ni = new AmiantCss3MenuBlockItem($niRow, $currentLevel);
