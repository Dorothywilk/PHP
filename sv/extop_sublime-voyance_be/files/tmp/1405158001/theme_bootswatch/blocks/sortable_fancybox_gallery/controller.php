	...
	class SortableFancyboxGalleryBlockController extends BlockController {
		...
		public function on_page_view() {
			if ($this->enableLightbox) {
                ...
                $v->addHeaderItem('<script type="text/javascript" src="' . $uh->getBlockTypeAssetsURL($bt) . '/jquery.fancybox-1.3.4/jquery.fancybox-1.3.4.pack.js"></script>');
                $v->addHeaderItem('<script type="text/javascript" src="' . $uh->getBlockTypeAssetsURL($bt) . '/jquery.fancybox-1.3.4/jquery.mousewheel-3.0.4.pack.js"></script>');
                $v->addHeaderItem('<script type="text/javascript" src="' . $uh->getBlockTypeAssetsURL($bt) . '/jquery.fancybox-1.3.4/jquery.easing-1.3.pack.js"></script>');
                $v->addHeaderItem('<link rel="stylesheet" href="' . $uh->getBlockTypeAssetsURL($bt) . '/jquery.fancybox-1.3.4/jquery.fancybox-1.3.4.css" type="text/css" media="screen" />');
			}
		}
