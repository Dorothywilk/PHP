...
<div class="poll well">
    <?php  if ($controller->hasVoted()) { ?>
            ...
            <?php  if(count($optionNamesAbbrev) && !$_GET['dontGraphPoll'] && $totalVotes>0){ ?>
                <div class="offset1 span2"><img border="" src="//chart.apis.google.com/chart?cht=p3&chd=t:<?php  echo join(',',$optionResults)?>&chs=180x180&chf=bg,s,FFFFFF00&chof=png&chco=<?php  echo join(',',$graphColors)?>" alt="<?php   echo t('survey results');?>" /></div>
            <?php   } ?>
