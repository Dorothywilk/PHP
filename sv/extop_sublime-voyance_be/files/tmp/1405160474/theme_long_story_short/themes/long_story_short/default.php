  	...
  	<div class="container-fluid">
  		<div class="navbar navbar-inverse <?php        if (!$c->isEditMode()) { ?>navbar-fixed-top<?php       } ?>">
  			<div class="navbar-inner">
				...
				?>
				<a class="brand" href="<?php  echo DIR_REL?>/"><?php  if($useSiteNameStack){$stack->display();} else{ echo SITE; } ?></a>
  				<?php       if (!$po->canWrite()){ ?>
			...
			<div class="span12 slides-container">
					...
					<div <?php        if (!$c->isEditMode()) { ?>class="navbar-fixed-bottom"<?php       } ?> id="footer">
					    ...
					    if (($a->getTotalBlocksInArea($c) > 0) || ($c->isEditMode())) {
					        ...
					        &copy; <?php       print date('Y') . ' ' . SITE. ' &sdot;  <a href="http://www.concrete5.org/" title="concrete5 content management system" target="_blank">Built with concrete5 CMS</a>'; ?>
					    <?php       } ?>
					    <?php        if (!$po->canWrite()) { ?>
