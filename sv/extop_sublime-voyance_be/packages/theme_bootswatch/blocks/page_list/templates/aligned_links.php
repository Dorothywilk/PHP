...
<?php   if ($showPagination): ?>
    <ul class="pager">
        <?php  if ($paginator->hasPreviousPage() != '') { ?>
            <li class="previous"><?php  echo str_replace('ltgray', '', $paginator->getPrevious('&laquo; ' . t('Previous'))) ?></li>
        <?php  } else { ?>
            <li class="previous disabled"><a href="#"><?php  echo '&laquo; ' . t('Previous') ?></a></li>
        <?php  } ?>

       <?php  if ($paginator->hasNextPage() != '') { ?>
            <li class="next"><?php  echo str_replace('ltgray', '', $paginator->getNext(t('Next') . ' &raquo;')) ?></li>
       <?php  } else { ?>
            <li class="next disabled"><a href="#"><?php  echo t('Next') . ' &raquo;' ?></a></li>
       <?php  } ?>
    </ul>
<?php   endif; ?>
