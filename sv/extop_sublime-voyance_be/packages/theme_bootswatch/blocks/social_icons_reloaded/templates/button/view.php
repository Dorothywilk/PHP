...
<!-- SOCIAL PROFILES -->
<div class="<?php      if (isset ($large)) : ?> btn-large<?php      endif;if (!isset ($text)) : ?> icons<?php      endif;?>">
     <?php  foreach ($profiles as $value => $url) :
        ...
        if ($url != null) :
            ...
            echo "<p><a class='btn' rel='external, nofollow, noindex' href=" . $url . " title='" . $title . "'><img src='" . $iconsPath . $value . "_" . $size . ".png' alt='" . $socialName . "' " . $style . " />" . $link . "</a></p>";
        endif;
    endforeach;?>
</div>
<!-- / SOCIAL PROFILES -->
