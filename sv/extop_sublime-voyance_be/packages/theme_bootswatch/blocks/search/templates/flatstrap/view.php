...
<form id="custom-search-form" action="<?php  echo $this->url( $resultTargetURL )?>" method="get" class="form-search form-horizontal">
	...
	<input name="query" type="text" value="<?php  echo htmlentities($query, ENT_COMPAT, APP_CHARSET)?>" class="input-medium search-query" placeholder="<?php  echo $buttonText?>"/>
