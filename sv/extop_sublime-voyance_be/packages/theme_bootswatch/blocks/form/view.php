...
<form name="<?php  echo $survey->surveyName; ?>" enctype="multipart/form-data" id="form<?php   echo $bID; ?>" method="post" action="<?php   echo $formAction ?>">
    ...
    <?php   foreach ($questions as $question): ?>
		<div class="control-group">
		    ...
		    <div class="controls">
		        <?php   if ($question['required']): ?>
		            <?php  $question['input'] =  str_replace('<input', '<input required="required"', $question['input']); ?>
		            <?php  $question['input'] =  str_replace('<textarea', '<textarea required="required"', $question['input']); ?>
		        <?php  endif; ?>
	...
	<?php   if ($captcha): ?>
		<div class="control-group captcha">
			<label class="control-label"><i class="text-error">* </i><?php   echo $translatedCaptchaLabel; ?></label>
			<div class="controls">
                <?php   $captcha->display(); ?>
