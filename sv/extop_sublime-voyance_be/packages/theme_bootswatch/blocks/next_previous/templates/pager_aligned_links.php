...
<div id="ccm-next-previous-<?php   echo $bID; ?>" class="pager">
    <ul>
        <li class="previous <?php  if (!isset($previousLinkURL)) echo 'disabled' ?>"><a href="<?php  echo $previousLinkURL; ?>"><?php  echo $previousLinkText; ?></a></li>
        <li class="<?php  if (!isset($parentLinkURL)) echo 'disabled' ?>"><a href="<?php  echo $parentLinkURL; ?>"><?php  echo $parentLinkText; ?></a></li>
        <li class="next <?php  if (!isset($nextLinkURL)) echo 'disabled' ?>"><a href="<?php  echo $nextLinkURL; ?>"><?php  echo $nextLinkText; ?></a></li>
    </ul>
</div>
